...
public class Silly implements Comparable<Silly>{
     ...
     *
     * @param firstString the first word in the name of this Silly instance.
     * @param secondString the second word in the name of this Silly instance.
     */
    ...
    public int compareTo(Silly other) {
         ...
         *                .length() method.
         */
        int thisLength = this.toString().length();
        int otherLength = other.toString().length();
